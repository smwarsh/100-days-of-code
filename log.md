...
**Thoughts**: I'm glad I was able to get MySQL installed and working. SQL seems cool so far. I got 3h 44m of sleep last night so I'm tired. I'm not sure if I did the right thing to show my work via the links, but it was the only export button I could find in PopSQL
...
**Thoughts**: I wanted to finish the video today, but I'm so exhausted I don't have the energy to keep going for another 40 minutes of video (however long that translates to in real time). I have to rest up because tomorrow is Wednesday - an early morning and a late night coming home.

**Links to work**:
1. [SQL course](https://www.freecodecamp.org/news/quincylarson/sql-and-databases-full-course--FLkLcFzA)
2. [SQL code in a .txt document because idk what else to do](https://github.com/smwarsh/sql-practice/blob/master/2018-10-09tutorial.txt)
...
**Thoughts**: I coded in the morning before work and planned to do the remaining 41 minutes of code at lunch, but my coworker asked me to get lunch together, and I had ditched him last week so I felt like I couldn't say no. By the time I got home from my 3-hour-round-trip activity at night, I was so exhausted I couldn't bring myself to finish the hour.
...
**Thoughts**: Glad to be done with the tutorial. I think once I finish the ER diagram I will switch back to working on Thrift for a while before doing the SQL tutorials recommended to me by @p_feyo.
...
**Today's Progress**: I kept working on the MySQL/PHP tutorial and taking notes. I finished "Select and Display Using PHP" and got to 21:00 in "Insert Data With PHP."

**Time Spent Coding**: 1h 1m

**Thoughts**: This is all very useful information.
...
**Today's Progress**: I finished "Update & Delete With PHP" and with that finished the whole section of the tutorial on how to connect a database to the webpage using PHP. Then, I coded static tables into my HTML for Thrift.

**Time Spent Coding**: 1h 0m

**Thoughts**: It feels good to be coding for Thrift again. The last time I worked on it was October 2, over 3 weeks ago.
...
### Day 77: November 1, 2018

**Today's Progress**: I finished echoing the database information onto the webpage. I started adding the hard-coded transactions from my JavaScript file to the database.

**Time Spent Coding**: 1h 2m

**Thoughts**: I'm so glad I did my coding at lunch. There's something amazing about getting coding done early in the day, or just not having to do it at night. I'm still really excited about the fact that my wimpy little static webpage is doing something as fancy as connecting to a database!
...
### Day 82: November 14, 2018

**Today's Progress**: I did 1 challenge in the FreeCodeCamp Basic Algorithm Scripting curriculum.

**Time Spent Coding**: 30m

**Thoughts**: I am finding it very difficult to get back into coding after the break. I am also finding it difficult to code while sick. My brain and body were both moving very slowly today.
...
### Day 84: November 18, 2018

**Today's Progress**: Today I finally decided to teach myself Firebase. I watched a video and a half by Firebase on Youtube to intorduce myself to it (I got to 9:19 in the second video).

**Time Spent Coding**: 55m

**Thoughts**: I was falling asleep while watching the second video, so I decided to call it quits for the day and continue tomorrow.
